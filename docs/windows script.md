...
Python installer should have options checked
- add python to path - to be accessible to script
- Use admin privileges - to avoid issues
- Disable path length limit (at end of installer may be helpful in avoiding issues)

Run Powershell as Admin
Install your preferred distro

```powershell
Install using 'wsl --install -d <Distro>'.                                                                                                                                                                                                                                                                                  NAME                   FRIENDLY NAME                                                                                                                       * Ubuntu                 Ubuntu                                                                                                                                Debian                 Debian GNU/Linux                                                                                                                      Ubuntu-18.04           Ubuntu 18.04 LTS                                                                                                                      Ubuntu-20.04           Ubuntu 20.04 LTS                                                                                                                      Ubuntu-22.04           Ubuntu 22.04 LTS  
```
